...
df_with_merged_features.to_csv('audiofile_dataset_with_features.csv', index=False)

print("Dataset with merged audio features saved as 'audiofile_dataset_with_features.csv'")