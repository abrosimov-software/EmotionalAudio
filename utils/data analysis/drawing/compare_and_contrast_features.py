...
def compare_all_emotions(df, emotion_list, feature_columns):
    for emotion1, emotion2 in combinations(emotion_list, 2):
        ...
        os.makedirs(os.path.join(current_dir, f'../../../reports/plots/Comparisons/{emotion1} vs {emotion2}'), exist_ok=True)
        ...
        for feature in feature_columns:
            ...
            plt.savefig(os.path.join(current_dir, f'../../../reports/plots/Comparisons/{emotion1} vs {emotion2}/comparison_{emotion1}_vs_{emotion2}_{feature}.png'), bbox_inches='tight', dpi=300)
            plt.close()
